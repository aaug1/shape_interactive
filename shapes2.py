...
class Shape():
  ...
  def get_color(self, points_3D):
    ...
    # if all 3 points have same x, or same y, surface is "on edge"    
    # if all 3 points have same z, surface is facing
    # Get the vector orthogonal to the plane, and calculate the angle
    vec_1 = point2 - point1
    vec_2 = point3 - point2
